...
CREATE TABLE students (
    ...
    education_level VARCHAR(50) NOT NULL CHECK (education_level IN ('bachelor', 'specialist', 'master', 'postgraduate', 'secondary')),
    social_category VARCHAR(100),
    ege_score INTEGER,
    has_olympiad BOOLEAN DEFAULT false,
    is_foreign BOOLEAN DEFAULT false,
    has_disability_hearing BOOLEAN DEFAULT false,
    has_disability_vision BOOLEAN DEFAULT false,
    is_need_based BOOLEAN DEFAULT false,
    regional_coefficient BOOLEAN DEFAULT false,
...
CREATE TABLE scholarship_rules (
    ...
    min_ege_score INTEGER,
    max_ege_score INTEGER,
    required_grade VARCHAR(10),
    social_requirement BOOLEAN DEFAULT false,
    requires_olympiad BOOLEAN DEFAULT false,
    requires_foreign BOOLEAN DEFAULT false,
    requires_disability BOOLEAN DEFAULT false,
    requires_need_based BOOLEAN DEFAULT false,
    is_first_course BOOLEAN DEFAULT false,
    amount_base DECIMAL(10,2) NOT NULL,
    amount_regional DECIMAL(10,2) NOT NULL,
